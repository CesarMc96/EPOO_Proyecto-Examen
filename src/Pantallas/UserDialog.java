    ...
    public UserDialog(Dialog f) {
        ...
        btnAceptar.addActionListener((ActionEvent ae) -> {
            ...
            try {
                ...
                Usuarios.add(new Persona(txtNombre.getText(), txtNickName.getText(), txtContrasena.getText(), (String) ListaRoles.getSelectedItem(), estado));
